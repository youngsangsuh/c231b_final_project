...
num_of_data = 99
resultCollection = np.zeros((3, num_of_data))
for i in range(1, num_of_data + 1):
    ...
    print('Done running RUN {} data'.format(i))
    ...
    resultCollection[:,i-1] = np.array([posErr_x[-1], posErr_y[-1], angErr[-1]])
...
mean_error = np.mean(resultCollection, axis = 0)
var_error = np.var(resultCollection, axis = 0)

print('Results over 1 ~ {}'.format(num_of_data))
print('Average error X', mean_error[0])
print('Average error Y', mean_error[1])
print('Average error theta', mean_error[2])
print('Variance error X', var_error[0])
print('Variance error Y', var_error[1])
print('Variance error theta', var_error[2])
